...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mShowSearhResultProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowSearhResultProgressBar = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    }
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mShowSearhResultProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            mShowSearhResultProgressBar.setVisibility(View.INVISIBLE);
